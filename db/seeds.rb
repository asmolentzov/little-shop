...
user_6 = User.create(name: 'Florence Bagnor', street: '47 Main Circle', city: 'Sylvania', state: 'OH',
  zip: '40078', email: 'baggy4@aol.com', password: 'birthday', role: 0, enabled: true)
...
current_price: 35000, enabled: true, image_link: 'ibm-monitor.jpg', description: 'Impressive Clarity and Definition')
### This item belonging to an active merchant is disabled ###
